...
**Status:** IN PROGRESS
**Roadmap:** `docs/roadmap.md` § M6 (Epics 6.2.2, 6.3.1, 6.3.3, 6.3.4, 6.4.2, 6.4.3)
...
| 6 | 6.3.3 | CausalChainPanel: "What led to this?" — navigable causal-edge graph for a selected event | TODO |
| 7 | 6.3.4 | Cross-panel linking: clicking civ/char/settlement name anywhere opens the profile panel | TODO |
| 8 | 6.4.2 | FirstRunOrientation: dismissible intro pointing at time controls, overlays, event log | TODO |
| 9 | 6.4.3 | EmptyStates: consistent handling for pre-sim, loading-save, and no-results-in-filter | TODO |
