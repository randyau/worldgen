...
public static class GoalManager
{
    ...
    internal static EntityId? FindNearbyRival(Tier1Character c, IWorldStateReadOnly world, int radius)
    {
    ...
    internal static EntityId? FindNearbyNeutral(Tier1Character c, IWorldStateReadOnly world, int radius)
    {
        foreach (var e in world.GetEntitiesInRadius(c.Location, radius))
        {
            if (e is Tier1Character other && other.Id != c.Id && other.IsAlive)
