...
public sealed class CulturalTraitsConfig
{
    ...
    public int   MilitaristicMinWars       { get; set; } = 10;
    ...
    public int   ResilientNearCollapsePopThreshold { get; set; } = 20;
