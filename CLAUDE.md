...
**Current milestone status:** M10 — Worldgen Preview & Modding IN PROGRESS (started 2026-07-26). Phases 10.0 (pipeline resume/replay), 10.1 (preview screen), and 10.2 (sim-config settings tab) done; see `docs/phases/m10_worldgen_preview_modding.md` for phase sequence and `docs/phases/archive/m10_phase0_pipeline_resume.md` / `m10_phase1_worldgen_preview_screen.md` / `m10_phase2_sim_config_settings_tab.md` for what shipped. Next: 10.3 (data modding). M9 (Created-Object Unification & Economic Depth) COMPLETE (2026-07-26) — see `docs/phases/archive/m9_created_object_unification.md`. Milestones were renumbered on 2026-07-23 when M8 was inserted (old M8→M9, M9→M10, M10→M11) — see `docs/roadmap.md`.
