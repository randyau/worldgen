...
**Current milestone status:** M13 — Generational & Domestic Drama IN PROGRESS (started 2026-08-01); phase 13.0 (marriage, household Family Organization, real childbirth with inheritance, weighted-loyalty war/raid dampening) done — see `docs/phases/m13_generational_domestic_drama.md` for phase sequence and remaining phases (13.1–13.5). M12 — Organization Model COMPLETE (2026-07-31); see `docs/phases/archive/m12_organization_model.md`. M11 — Scale is otherwise complete (perf + local-scale gen); packaging/distribution pushed out to final pre-release milestone M19, see `docs/roadmap.md` § "M19". M10 — Worldgen Preview & Modding COMPLETE (2026-07-26); see `docs/phases/archive/m10_worldgen_preview_modding.md` for phase sequence. M9 (Created-Object Unification & Economic Depth) COMPLETE (2026-07-26) — see `docs/phases/archive/m9_created_object_unification.md`. Milestones were renumbered on 2026-07-23 when M8 was inserted (old M8→M9, M9→M10, M10→M11) — see `docs/roadmap.md`.

**For coding sessions — read the active phase doc:**
- M13 (Generational & Domestic Drama) IN PROGRESS — see `docs/phases/m13_generational_domestic_drama.md`. Phase 13.0 done; 13.1 (Fear as submission/appeasement axis) is next.
