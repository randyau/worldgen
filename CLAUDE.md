...
- M13.8 (Tier2 Relationship Exposure, phases 13.8.0–13.8.3) IN PROGRESS — 13.8.0/13.8.1 shipped 2026-08-03, 13.8.2 (Notability)/13.8.3 (balance/perf validation) not started — see `docs/phases/m13_8_tier2_relationship_exposure.md`. Finish this before M14. M14 (Economy & Independent Wealth) is next after that per `docs/roadmap.md`; no phase doc exists yet.
